...
class SimpleSelfAttentionModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # avg pooling to get a sentence embedding
        m = nn.AvgPool2d((T, 1)) # (B,C)
        x = m(x) 
...
class TransformerEncoderModel(nn.Module):
    def __init__(self, output_size, embeddings, max_length=60, n_head=5, n_layer=4):
        super().__init__()
